    ...
    <div className="w-full h-full mx-auto p-3 flex flex-col items-center justify-center">
      ...
      {shortUrl && (
        <div className="bg-gray-100 p-4 rounded">
          <p className="text-[black]">Short url: <a href={shortUrl} className="text-blue-600">{shortUrl}</a></p>
          <p className="text-[black]">Stats: <a href={statsUrl} className="text-blue-600">{statsUrl}</a></p>
        </div>
      )}
    </div>
  );
